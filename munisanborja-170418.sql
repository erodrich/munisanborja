...
CREATE TABLE `Requerimiento` (
  ...
  KEY `fk_Requerimiento_persona1_idx` (`persona_idPersona`),
  ...
  CONSTRAINT `fk_Requerimiento_persona1` FOREIGN KEY (`persona_idPersona`) REFERENCES `persona` (`idPersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `RequerimientoEvaluado` VALUES (1,3,15000,12500,450,375),(10,18.9,9000,87600,1701,16556.399999999998);
...
INSERT INTO `informetecnico` VALUES (1,'Informe Impacto Medioambiental','2018-03-15',NULL,NULL,'ERODRICH',NULL,NULL,1),(2,'Impacto en Vias Públicas','2018-04-01',NULL,NULL,'ERODRICH',NULL,NULL,2);
...
INSERT INTO `persona` VALUES (1,'12345678','Juan Carlos','Perez Garcia','12345678',1),(2,'11223344','Victor','Jimenez Lopez','11223344',1);
...
INSERT INTO `proyectopreinversion` VALUES (1,'P00001','2018-03-01','2019-03-31','2018-03-01',6048000,1500000,800000,2,1,1,3),(2,'P00002','2018-04-01','2019-01-31',NULL,42203.7,0,0,2,2,1,4),(3,'P00003','2018-04-10','2018-12-31',NULL,0,0,0,2,3,1,3);
...
-- Dump completed on 2018-04-17 20:56:01

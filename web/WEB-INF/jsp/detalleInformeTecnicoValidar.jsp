                ...
                <div class="card">
                    <div class="card-body">   
                        <div class="row">
                            ...
                            <a href="${pageContext.request.contextPath}/resumenEvaluacionValidar/${informetecnico.codigo}.htm"><button type="button" class="btn btn-primary  btn-sm">Viabilizar Inform Técnico</button></a>&nbsp;&nbsp;

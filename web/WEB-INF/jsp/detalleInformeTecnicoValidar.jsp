                ...
                <div class="card">
                    <div class="card-body">   
                        <div class="row">
                            ...
                            <div class="form-group col-xs-10 col-sm-6 col-md-6 col-lg-6">
                                <label for="fechaRechazo">Nombre Requerimiento: </label>
                            ...
                            <a href="${pageContext.request.contextPath}/resumenEvaluacionValidar/${informetecnico.codigo}.htm"><button type="button" class="btn btn-primary  btn-sm">Viabilizar Informe Técnico</button></a>&nbsp;&nbsp;
